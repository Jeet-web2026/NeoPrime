            ...
            <div class="card-body px-0">
                <div class="card mb-3 border-0 shadow-sm position-relative py-1" style="background-color: #5404f5;">
                    <div class="row g-0 align-items-center px-2">
                        ...
                        <div class="col-md-9">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase fs-5 mb-0 fw-bold text-light text-center">admin portal</h5>
                ...
                <div class="card mb-3 border-0 shadow-sm position-relative py-1" style="background-color: #5404f5;">
                    <div class="row g-0 align-items-center px-2">
                        ...
                        <div class="col-md-9">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase fs-5 mb-0 fw-bold text-light text-center">partner's portal</h5>
                                <a href="" class="stretched-link"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card mb-3 border-0 shadow-sm position-relative py-1" style="background-color: #5404f5;">
                    <div class="row g-0 align-items-center px-2">
                        ...
                        <div class="col-md-9">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase fs-5 mb-0 fw-bold text-light text-center">employee's portal</h5>
                                <a href="" class="stretched-link"></a>
                            </div>
                        </div>
                    </div>
